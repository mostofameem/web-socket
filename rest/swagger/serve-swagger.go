...
// 	"strings"
// 	"user-pulse/config"
// 	"user-pulse/rest/middlewares"
// 	"user-pulse/rest/utils"
// )
...
// func SetupSwagger(conf *config.Config, mux *http.ServeMux, manager *middlewares.Manager) {
// 	if conf.Mode == config.ReleaseMode {
// 		return
// 	}

// 	mux.Handle("GET /user-pulse/swagger/{path...}",
// 		manager.With(
